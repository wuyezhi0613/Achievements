!function (a) {
  ...
  b.prototype = {
    "constructor": b, "over": !1, "inDrag": !1, "showTooltip": function () {
      ...
      var c = this.calculateValue();
      return this.element.trigger({"type": "slideStop", "value": c}).data("value", c).prop("value", c), !1
